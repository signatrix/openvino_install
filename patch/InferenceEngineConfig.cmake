...
if(TARGET IE::inference_engine)
        ...
        if (WIN32)
           ...
           if (NOT EXISTS "/etc/lsb-release")
            ...
            elseif (${os_name} STREQUAL "poky 2.0")
                ...
                message(FATAL_ERROR "${os_name} is not supported. List of supported OS: Ubuntu 14.04, Ubuntu 16.04, Ubuntu18.04, CentOS 7")
            endif()
        endif()
    endif()
    ...
    # set(IE_FOUND TRUE) #hacky hack
    if(IE_FOUND)
        # message(FATAL_ERROR "IE_FOUND")
